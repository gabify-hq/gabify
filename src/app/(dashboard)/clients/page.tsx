  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden">
      ...
      <div className="flex items-center gap-2.5 border-b border-zinc-800 px-5 py-3">
        <Users className="h-4 w-4 stroke-[1.5] text-zinc-500" />
        <h1 className="text-[13px] font-semibold text-zinc-200">Clientes</h1>
      ...
      <div className="flex-1 overflow-y-auto px-5 py-4">
        <div className="mx-auto max-w-3xl space-y-5">
          ...
          <div className="flex items-center gap-5 border-b border-zinc-800 pb-4">
            ...
            <div className="ml-auto text-[11px] text-zinc-600">Abril 2025</div>
          </div>
          ...
          {missing.length > 0 && (
            <section>
              <div className="mb-2 flex items-center gap-1.5">
                <AlertCircle className="h-3.5 w-3.5 stroke-[1.5] text-red-400" />
          ...
          {incomplete.length > 0 && (
            <section>
              <div className="mb-2 flex items-center gap-1.5">
                <Clock className="h-3.5 w-3.5 stroke-[1.5] text-amber-400" />
          ...
          {complete.length > 0 && (
            <section>
              <div className="mb-2 flex items-center gap-1.5">
                <CheckCircle2 className="h-3.5 w-3.5 stroke-[1.5] text-green-400" />
