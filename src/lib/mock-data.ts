...
export const MOCK_DOCUMENTS: MockDocument[] = [
  // Farmácia Central
  { id: 'doc-001', clientId: 'client-002', clientName: 'Farmácia Central do Porto', filename: 'fatura_medline_04_2025.pdf', type: 'INVOICE_RECEIVED', typeLabel: 'Fatura recebida', confidence: 0.97, status: 'CLASSIFIED', extractedDate: '30/04/2025', extractedAmount: 4231.80, extractedVATNumber: '512345678', r2Key: 'office-001/client-002/email-001/att-001.pdf', createdAt: new Date('2025-05-02T14:34:00'), period: '04/2025' },
  { id: 'doc-002', clientId: 'client-002', clientName: 'Farmácia Central do Porto', filename: 'fatura_roche_diagnostics.pdf', type: 'INVOICE_RECEIVED', typeLabel: 'Fatura recebida', confidence: 0.95, status: 'CLASSIFIED', extractedDate: '28/04/2025', extractedAmount: 1875.00, extractedVATNumber: '501123456', r2Key: 'office-001/client-002/email-001/att-002.pdf', createdAt: new Date('2025-05-02T14:34:10'), period: '04/2025' },
  { id: 'doc-003', clientId: 'client-002', clientName: 'Farmácia Central do Porto', filename: 'fatura_doc_final_v3.pdf', type: 'INVOICE_RECEIVED', typeLabel: 'Fatura recebida', confidence: 0.72, status: 'NEEDS_REVIEW', extractedDate: '25/04/2025', extractedAmount: 634.50, extractedVATNumber: null, r2Key: 'office-001/client-002/email-001/att-003.pdf', createdAt: new Date('2025-05-02T14:34:20'), period: '04/2025' },
  // Restaurante O Tejo
  { id: 'doc-004', clientId: 'client-003', clientName: 'Restaurante O Tejo', filename: 'declaracao_iva_q1_2025.pdf', type: 'TAX_DOCUMENT', typeLabel: 'Documento fiscal', confidence: 0.94, status: 'CLASSIFIED', extractedDate: '30/04/2025', extractedAmount: 2340.00, extractedVATNumber: '507654321', r2Key: 'office-001/client-003/email-002/att-001.pdf', createdAt: new Date('2025-05-02T11:17:00'), period: '04/2025' },
  // TechStart Lisboa
  { id: 'doc-005', clientId: 'client-004', clientName: 'TechStart Lisboa', filename: 'processamento_salarial_abril_2025.xlsx', type: 'PAYROLL', typeLabel: 'Recibo de vencimento', confidence: 0.91, status: 'CLASSIFIED', extractedDate: '30/04/2025', extractedAmount: 47820.00, extractedVATNumber: '514567890', r2Key: 'office-001/client-004/email-003/att-001.xlsx', createdAt: new Date('2025-05-02T09:50:00'), period: '04/2025' },
  { id: 'doc-006', clientId: 'client-004', clientName: 'TechStart Lisboa', filename: 'mapa_ferias_abril.pdf', type: 'OTHER', typeLabel: 'Outro', confidence: 0.55, status: 'NEEDS_REVIEW', extractedDate: null, extractedAmount: null, extractedVATNumber: null, r2Key: 'office-001/client-004/email-003/att-002.pdf', createdAt: new Date('2025-05-02T09:50:10'), period: '04/2025' },
  // Clínica Dentária
  { id: 'doc-007', clientId: 'client-005', clientName: 'Clínica Dentária Sousa & Melo', filename: 'extrato_bpi_abril_2025.pdf', type: 'BANK_STATEMENT', typeLabel: 'Extrato bancário', confidence: 0.98, status: 'CLASSIFIED', extractedDate: '30/04/2025', extractedAmount: null, extractedVATNumber: null, r2Key: 'office-001/client-005/email-006/att-001.pdf', createdAt: new Date('2025-04-29T15:41:00'), period: '04/2025' },
  { id: 'doc-008', clientId: 'client-005', clientName: 'Clínica Dentária Sousa & Melo', filename: 'faturas_fornecedores_pack.pdf', type: 'INVOICE_RECEIVED', typeLabel: 'Fatura recebida', confidence: 0.89, status: 'REVIEWED', extractedDate: '29/04/2025', extractedAmount: 8920.00, extractedVATNumber: '508123456', r2Key: 'office-001/client-005/email-006/att-002.pdf', createdAt: new Date('2025-04-29T15:41:10'), period: '04/2025' },
  { id: 'doc-009', clientId: 'client-005', clientName: 'Clínica Dentária Sousa & Melo', filename: 'ss_declaracao_marco_2025.pdf', type: 'SOCIAL_SECURITY', typeLabel: 'Segurança Social', confidence: 0.96, status: 'CLASSIFIED', extractedDate: '15/04/2025', extractedAmount: 3240.00, extractedVATNumber: '508123456', r2Key: 'office-001/client-005/email-006/att-003.pdf', createdAt: new Date('2025-04-29T15:41:20'), period: '03/2025' },
  // Construtora Alves
  { id: 'doc-010', clientId: 'client-001', clientName: 'Construtora Alves & Filhos', filename: 'extrato_cgd_abril_2025.pdf', type: 'BANK_STATEMENT', typeLabel: 'Extrato bancário', confidence: 0.99, status: 'REVIEWED', extractedDate: '30/04/2025', extractedAmount: null, extractedVATNumber: null, r2Key: 'office-001/client-001/email-xxx/att-001.pdf', createdAt: new Date('2025-04-28T10:00:00'), period: '04/2025' },
