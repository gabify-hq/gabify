<!-- Source: https://www.moloni.pt/dev/documents/documents/countmodifiedsince/ — fetched 2026-07-07, extracted verbatim from raw HTML (raw copy in docs/raw/documents_documents_countmodifiedsince.html) -->
...
Moloni API / Endpoints / Documents / Documents / countModifiedSince

# countModifiedSince

Disponível na versão: 1.20+

Devolve a contagem de documentos que foram alterados ou criados desde uma determinada data e hora.

Para al&eacute;m de ser chamado atrav&eacute;s deste endpoint, tamb&eacute;m pode ser chamado atrav&eacute;s dos endpoints de tipos de documentos espec&iacute;ficos, como invoices/countModifiedSince, por exemplo.

Pedido

https://api.moloni.pt/v1/documents/countModifiedSince/?access_token=[current_access_token]
