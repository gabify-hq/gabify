<!-- Source: https://www.moloni.pt/dev/documents/invoices/count/ — fetched 2026-07-07, extracted verbatim from raw HTML (raw copy in docs/raw/documents_invoices_count.html) -->
...
Moloni API / Endpoints / Documents / Invoices / count
...
https://api.moloni.pt/v1/invoices/count/?access_token=[current_access_token]
