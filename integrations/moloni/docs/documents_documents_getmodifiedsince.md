<!-- Source: https://www.moloni.pt/dev/documents/documents/getmodifiedsince/ — fetched 2026-07-07, extracted verbatim from raw HTML (raw copy in docs/raw/documents_documents_getmodifiedsince.html) -->
...
Moloni API / Endpoints / Documents / Documents / getModifiedSince
...
Para al&eacute;m de ser chamado atrav&eacute;s deste endpoint, tamb&eacute;m pode ser chamado atrav&eacute;s dos endpoints de tipos de documentos espec&iacute;ficos, como invoices/getModifiedSince, por exemplo.

Pedido

https://api.moloni.pt/v1/documents/getModifiedSince/?access_token=[current_access_token]
